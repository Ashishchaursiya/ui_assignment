...
const FooterLink: React.FC<FooterLinkProps> = ({ imageSrc, altText, title }) => (
  <div className="mt-3 col-span-6 sm:col-span-2 flex flex-col items-start">
  ...
  return (
    <>
      <div className="mx-auto max-w-6xl px-2 sm:px-6 lg:px-8 sm:mt-20">
        ...
        <div className="grid grid-cols-12 p-3 gap-x-5">
          ...
          <div className="col-span-12 sm:col-span-2 my-3">
          ...
          <div className="col-span-12 sm:col-span-5 my-3">
